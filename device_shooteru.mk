...
# Prebuilt cool clock widget
PRODUCT_COPY_FILES += \
    device/htc/shooteru/prebuilt/icsclock.apk:system/app/icsclock.apk
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/shooteru/ramdisk/init.rc:root/init.rc \
...
PRODUCT_COPY_FILES += \
    device/htc/shooteru/prebuilt/init:recovery/root/init \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_KERNEL):kernel \
    device/htc/shooteru/modules/bcmdhd.ko:/system/lib/modules/bcmdhd.ko \
